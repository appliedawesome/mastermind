...
class Target::Server::EC2 < Target
  attribute :aws_access_key_id, type: String, default: -> { Mastermind::Config.ec2.aws_access_key_id }
  attribute :aws_secret_access_key, type: String, default: -> { Mastermind::Config.ec2.aws_secret_access_key }
